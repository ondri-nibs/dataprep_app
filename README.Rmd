...
* Type ```ONDRIDataPrepApp::installPackages()``` to install any missing packages and/or dependencies.
...
* When installation is complete, type ```ONDRIDataPrepApp::runApp()``` to open the app.